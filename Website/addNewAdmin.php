  ...
  if(isset($_POST["submit"]))
    {
        ...
        $sql="INSERT INTO editor (firstName, lastName, email, password)VALUES('$firstName','$lastName','$email','$passwordEn')";
        ...
        if(mysqli_query($conn,$sql)) {
                    ...
                    $subject = "Project Management System Editor [pswd]"; 
...
<body>
 <a href="showEditor.php"> <button name="show" class="btn-4">Show Editor list</button> </a>
<a href="editor_home.php"> <button name="show" class="btn-5">Go to Home</button> </a> <br><br>

<form method="POST" action="addNewAdmin.php">
    <div class="form">
      <div class="title">Welcome to Add New Editor page</div>
      <div class="subtitle">In here You can add New Editor</div>
