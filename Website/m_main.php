...
include 'validation.php';
 ...
 $sql1 = $conn->query("SELECT id FROM member where reg_num = '$reg_number'");
 $data12 = $sql1->fetch_assoc();
...
?>
					...
					<div class="card">
						...
						<div class="sci">
							<li>
								<a href='m_dPro.php?data= <?php echo "$proNo[0]"?>' name="start">SEE IT</a>
							</li>
						</div>
					</div>
